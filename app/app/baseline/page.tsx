...
// Relocated from `/` (decisions.md, 2026-09-02) so the root route serves
// the actual product -- the conversational interface -- rather than this
// deliberately-broken comparison. This page is Phase 1's naive pure-vector
// baseline: every catalog frame embedded as a flattened prose blurb, no
// SQL filtering, no metadata constraints, no reranking. It exists to be
// watched failing on constraint queries (price ceilings, exact material,
// stock status) -- that failure is the evidence every later architectural
// decision in this project is measured against (see
// docs/phase1-baseline-failures.md and PROJECT_CONTEXT.md §1-2). It is
// not, and was never meant to be, the thing being demonstrated as a
// finished product.
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-50">
      <main className="mx-auto max-w-3xl px-6 py-12">
        <div className="mb-4 rounded-lg border border-amber-300 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/40 px-4 py-3 text-sm text-amber-900 dark:text-amber-200">
          <strong>This is a deliberately-broken comparison, not the product.</strong>{" "}
          It exists to demonstrate the failure mode the real system was built to
          avoid. For the actual recommender, see{" "}
        ...
        <h1 className="text-2xl font-semibold tracking-tight">
          Phase 1 — Naive Pure-Vector RAG Baseline
        </h1>
